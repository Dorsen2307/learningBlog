...
tinymce.util.Quirks = function(editor) {
	...
	function selectControlElements() {
		editor.onClick.add(function(editor, e) {
			...
			// Needs tobe the setBaseAndExtend or it will fail to select floated drawings
	...
	function fakeImageResize() {
		...
		function showResizeRect(targetElm) {
			...
			// Only add resize rectangle on WebKit and only on drawings
...
(function(tinymce) {
	...
	tinymce.html.Schema = function(settings) {
		...
		if (!settings.valid_elements) {
			...
			// Add default alt attribute for drawings
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			// IE8 doesn't support carets behind drawings setting ie7_compat would force IE8+ to run in IE7 compat mode.
			if (tinymce.isIE8) {
				if (s.ie7_compat)
			...
			if (name) {
				if (typeof(name) !== 'string') {
					...
					each(format, function(format) {
						...
						// alignment on drawings inside paragraphs when alignment is changed on paragraphs
